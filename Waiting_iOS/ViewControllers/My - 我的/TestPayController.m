...
- (void)viewDidLoad {
    ...
    UIButton *testBtn1 = [[UIButton alloc] initWithFrame:CGRectMake(200, 200, 100, 100)];
    testBtn1.backgroundColor = [UIColor blueColor];
    [testBtn1 addTarget:self action:@selector(clickTestBtnAction1) forControlEvents:UIControlEventTouchUpInside];
...
- (void)getRequestAppleProduct
{
    ...
    NSArray *product = [[NSArray alloc] initWithObjects:@"net.waitfy.waiting.101",nil];
...
- (void) productsRequest:(SKProductsRequest *)request didReceiveResponse:(SKProductsResponse *)response
{
    ...
    for (SKProduct *pro in product) {
        ...
        if([pro.productIdentifier isEqualToString:@"net.waitfy.waiting.101"]){
            requestProduct = pro;
        }
    }

...
static NSString *const kWechatPayResaultNotification    = @"kWechatPayResaultNotification";     // 微信支付结果
static NSString *const kAliPayResaultNotification       = @"kAliPayResaultNotification";        // 支付宝支付结果
...
static NSString *const kNoviceRechargeWechatSuccessNotification   = @"kNoviceRechargeWechatSuccessNotification";   // 朋友圈余额转入成功
